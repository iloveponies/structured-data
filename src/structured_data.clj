...
(defn add-author [book new-author]
  (let [aut (:authors book)
        news (conj aut new-author)]
    (assoc book :authors news)))
...
(defn book->string [book]
  (let [name (:title book)
        authorsc (:authors book)
        authors (authors->string authorsc)]
...
(defn author-by-name [name authors]
  (let [res (filter (fn [x] (= (:name x) name)) authors)]
