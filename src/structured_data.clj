...
(defn contains-point? [rectangle point]
  (let [[[x1 y1] [x2 y2]] rectangle [x3 y3] point]
    (and (and (<= x1 x3) (>= x2 x3)) (and (<= y1 y3) (>= y2 y3)))))
...
(defn author->string [author]
  (let [name (:name author)
        ...
        year-string (if birth-year (str " (" birth-year " - " death-year ")") nil)]
...
(defn books->string [books]
  (let [book-strings (apply str (interpose ". " (map book->string books)))]
    (cond
     ...
     (= (count books) 1) (str "1 book. " book-strings ".")
     :else
       (str (count books) " books. " book-strings "."))))
