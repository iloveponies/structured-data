...
(defn add-author [book new-author]
  (let [books-authors (:authors book)]
    (assoc book :authors (conj books-authors new-author))))
...
(defn old-book->new-book [book]
  (let [books-authors (:authors book)]
    (assoc book :authors (set books-authors))))
...
(defn books->string [books]
  (cond
    ...
    (== 1 (count books)) (str (count books) " book. " (apply str (interpose ". " (map book->string books))) ".")
