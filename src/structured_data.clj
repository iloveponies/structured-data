...
(defn author->string [author]
  (let [name (author :name) byear (author :birth-year) dyear (author :death-year)]
    (str name (if (contains? author :birth-year) (str " (" byear " - " dyear ")")))))
