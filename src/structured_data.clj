...
(defn add-author [book new-author]
  (let [authors (:authors book)
        authorsNew (conj authors new-author)]
    (assoc book :authors authorsNew)))
...
(defn books->string [books]
  (let [booksCount (count books)
        books->string (str (apply str (interpose ". " (map book->string books))) \.)]
    (cond (== booksCount 0) "No books."
          (== booksCount 1) (str "1 book. " books->string)
          :else (str booksCount " books. " books->string))))
