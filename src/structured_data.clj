...
(defn contains-point? [rectangle point]
  (let [[x y] point
        [[min-x min-y] [max-x max-y]] rectangle]
...
(defn second-elements [collection]
  (map (fn [s] (second s)) collection))

(defn titles [books]
  (map :title books))

(defn monotonic? [a-seq]
  (let [monotonic (fn [c s]
             (apply c s))]
    (or (monotonic >= a-seq) (monotonic <= a-seq))
  ))
