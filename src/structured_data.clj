...
(defn spiff-destructuring [v]
  (let [the-first (get v 0) third (get v 2)]
    (+ the-first third)))
...
(defn books->string [books]
  (let [book-count (count books)]
    (let [book-description (apply str (interpose ". " (map book->string books)))]
      (cond (= 0 book-count) "No books."
            (= 1 book-count) (str book-count " book. " book-description ".")
            :else (str book-count " books. " book-description ".")))))
