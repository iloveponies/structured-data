...
(defn spiff-destructuring [[f s t]]
  (+ f t))
...
(defn books->string [books]
  (let [n (count books)
        sen (if (== 1 n) " book. " " books. ")]
    (if (== 0 n)
      "No books."
      (str n sen (apply str (interpose ". " (map book->string books))) "."))))
