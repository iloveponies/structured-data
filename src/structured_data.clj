...
(defn author->string [author]
  (let [name  (:name author)
        ...
        dy    (if (contains? author :death-year) (:death-year author) "")
        years (if by (str " (" by " - " dy ")"))]
    (str name years)))
...
(defn books->string [books]
  (let [num-books       (count books)
    ...
    (cond
      (< num-books 1) "No books."
      (== num-books 1) (str "1 book. " (book->string (get books 0)) ".")
      (> num-books 1) (str num-books " books. " books-as-string "."))))
