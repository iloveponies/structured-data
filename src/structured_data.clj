...
(defn author->string [author]
  (let [n (:name author)
        years (if (:birth-year author) (str " (" (:birth-year author) " - " (:death-year author) ")") (str ""))]
    (str n  years)))
...
(defn books->string [books]
  (if (> (count books) 0) (str (if (> (count books) 1) (str (count books) " books. ") "1 book. ") (apply str (interpose " " (map (fn [x] (str (book->string x) ".")) books)))) "No books."))
