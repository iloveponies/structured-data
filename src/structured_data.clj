...
(defn author->string [author]
  (let [author-name (:name author)
        birth-year (if (contains? author :birth-year) (str (:birth-year author)) "")
        death-year (if (contains? author :death-year) (str (:death-year author)) "")]
        (cond
          (and (empty? birth-year) (empty? death-year)) author-name
          (empty? death-year) (str author-name " (" birth-year " - )")
