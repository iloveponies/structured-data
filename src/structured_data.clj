...
(defn author->string [author]
  (let [auname (:name author)]
  (cond
   (contains? author :death-year) (str auname " (" (:birth-year author) " - " (:death-year author) ")")
   (contains? author :birth-year) (str auname " (" (:birth-year author) " - )")
   :else                          auname
  )))
