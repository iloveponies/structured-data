...
(defn all-author-names [books]
  (set (apply clojure.set/union (map (fn [book] (map :name (:authors book))) books))))
...
(defn books->string [books]
  (if (> (count books) 0)
    (str (if (= (count books) 1) "1 book. " (str (count books) " books. "))
         (apply str (interpose " " (map (fn [bookstr] (str bookstr ".")) (map book->string books)))))
    "No books."))
