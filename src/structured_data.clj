...
(defn author->string [author]
  (let [name->string (fn [author] (str (:name author)))]
  (let [years->string (fn [author]
    (if (:birth-year author)
    (str " (" (:birth-year author) " - " (:death-year author) ")") ""))]
  (str (name->string author) (years->string author)))))
...
(defn books->string [books]
  ...
  (let [booklisting (fn [books]
    (apply str (interpose ". " (map book->string books))))]

  (str (bookcount books) (booklisting books) "."))))
