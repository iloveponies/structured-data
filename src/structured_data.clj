...
(defn contains-rectangle? [outer inner]
  (let [[leftup rightdown] inner]
    (and (contains-point? outer leftup) (contains-point? outer rightdown))))
...
(defn add-author [book new-author]
  (let [authors (:authors book)
        new-book (assoc book :authors (conj authors new-author))]
    new-book))
...
(defn has-a-living-author? [book]
  (let [living-books (filter (fn [author] (alive? author)) (:authors book))]
    (< 0 (count living-books))))
