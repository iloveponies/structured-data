...
(defn books->string [books]
  (let [book-str (fn [book] (str " " (book->string book) "."))
        pluralise (fn [num string] (if (= num 1) string (str string "s")))
        book-count (count books)]
    (if (zero? book-count)
      "No books."
      (str book-count " " (pluralise book-count "book") "." (apply str (map book-str books))))))
