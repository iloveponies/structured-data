...
(defn add-author [book new-author]
  (let [book-authors (:authors book)
        book-updated (assoc book :authors (conj book-authors new-author))]
    book-updated))
...
(defn second-elements [collection]
  (let [get-2nd (fn [vect] (get vect 1))]
...
(defn books->string [books]
  (let [books-count (count books)
        books-str   (if (== books-count 1)
                      " book. "
                      " books. ")]
    (if (== books-count 0)
      "No books."
      (str books-count books-str (apply str (interpose ". " (map book->string books))) "."))))
