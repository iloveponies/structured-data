...
(defn author->string [author]
  (if (:birth-year author) (str (:name author) " (" (:birth-year author) " - " (:death-year author) ")") (str (:name author))))
...
(defn books->string [books]
  (if (= 0 (count books)) "No books." (str (count books) " book" (if (> (count books) 1) "s. " ". ") (apply str (interpose ", " (map book->string books))) ".")))
