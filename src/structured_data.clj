...
(defn contains-rectangle? [outer inner]
  (let [[ptlowleft pttoprgt] inner]
    (and (contains-point? outer ptlowleft) (contains-point? outer pttoprgt))))
...
(defn add-author [book new-author]
  (let [author-list (conj (:authors book) new-author)]
    (assoc book :authors author-list)))  
