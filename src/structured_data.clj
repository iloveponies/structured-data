...
(defn contains-rectangle? [outer inner]
  (let [outer-rectangle outer
        [bottom-left top-right] inner]
    (and (contains-point? outer-rectangle bottom-left)
         (contains-point? outer-rectangle top-right))))
...
(defn second-elements [collection]
  (let [get-second-element (fn [x] (first (rest x)))]
