...
(defn author->string [author]
  (let [name (:name author)
      years (if (:birth-year author) (str "(" (:birth-year author) " - " (:death-year author) ")") false)]
    (if years (str name " " years)(str name))
  )
)
...
(defn books->string [books]
 (cond 
  ...
  (= (count books) 1) (str "1 book. " (book->string (first (seq books))) ".")
