...
(defn author->string [author]
  (let [years 
        (if (contains? :birth-year author)
          (format " (%s - %s)" 
                  (:birth-year author) 
                  (if (contains? :death-year author) (:death-year author) ""))
          "")]
...
(defn book->string [book]
  (str (:name book) ", written by " (authors->string (:authors book))))
